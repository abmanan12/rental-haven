    ...
    return (
        <>
            ...
            <footer className='bg-dark'>
                <div className="pt-3 pt-md-5 text-light">
                    <div className="container">
                        <div className="row mt-3">

                            <div className="col-md-4 col-lg-5 col-xl-5 mb-4 px-lg-4">
                                <h6 className="fw-bold mb-3 mb-md-2 mb-lg-4"><img src="/assets/images/logoo.png"
                            ...
                            <div className="col-md-4 col-lg-4 col-xl-4 mx-auto mb-4 mt-3 mt-lg-0">
                                ...
                                <div className="input-group ps-3 ps-md-0 pt-2" style={{ maxWidth: '256px' }}>
                                    ...
                                    <div className="input-group-append">
                                        <button className="btn btn-info text-white footer-button" type="button">SEND</button>
                                    </div>
                                </div>
